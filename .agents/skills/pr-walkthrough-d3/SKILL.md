...
- `.warp/pr-walkthrough-d3/index.html`
...
Use visual artifacts as node attachments or detail-panel figures, not as a replacement for explaining the diff. Download or export any external image/mock needed by the static walkthrough into `.warp/pr-walkthrough-d3/assets/` and reference it with a relative path, or embed it as a data URI when simpler. Do not hotlink remote images in the generated HTML.
...
Use helper output:
```bash
python3 .agents/skills/pr-walkthrough-d3/scripts/d3_canvas_runtime.py --css
python3 .agents/skills/pr-walkthrough-d3/scripts/d3_canvas_runtime.py --runtime
python3 .agents/skills/pr-walkthrough-d3/scripts/d3_canvas_runtime.py --template --data graph.json > .warp/pr-walkthrough-d3/index.html
```
...
```bash
python3 .agents/skills/pr-walkthrough-d3/scripts/validate_d3_canvas.py --html .warp/pr-walkthrough-d3/index.html --require-browser
```
